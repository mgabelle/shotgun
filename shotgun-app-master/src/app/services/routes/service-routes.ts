...
export class FamilleRoutes {
  ...
  public static GET_FAMILLES_DISPONIBLES(date: string) {
    return `${this.GET_FAMILLES()}/dispo/${date}`;
    }
}
...
export class PartieCommunesRoutes {
    ...
    public static GET_PARTIES_COMMUNES_DISPONIBLES(date: string) {
        return `${this.GET_PARTIES_COMMUNES()}/dispo/${date}`;
    }
